...
<span class="url1">www.comoseva.com/aqui.php?lat=<span id="longspan"></span>&amp;long=<span id="latspan"></span></span></td></tr></table>
  ...
  <table width="980">
    <tr>
      <td colspan="2" align="center"><font size="4">O si lo prefieres, personaliza la direcci&oacute;n poni&eacute;ndola un nombre: (por ejemplo: www.comoseva.com/<strong>restaurantefiestanavidad</strong>) </font></td>
    </tr>
    <tr><td align="right" valign="top">
www.comoseva.com/</td><td>
  <input name="textoprincipal" type="text" id="textoprincipal" size="50" onblur="this.value=removeSpaces(this.value);" /><span id="msgbox" style="display:none"></span></td></tr>
    <tr>
      <td colspan="2" align="center" valign="top"><font color="#999999" size="1">(si usas espacios, ser&aacute;n sustituidos por guiones. ATENCION: todo contenido ser&aacute; visible para TODO EL MUNDO en la parte inferior de esta p&aacute;gina. La IP quedar&aacute; registrada) </font></td>
    </tr>

 <tr><td align="right">
  
  Escribe una breve descripci&oacute;n: </td><td>
  <input name="textoconespacios" type="text" id="textoconespacios" size="50" />
    ...
    <td><input name="comentarios" type="text" id="comentarios" size="100" /> 
  </td></tr>
   <tr>
    <td align="right">
...
echo recaptcha_get_html($publickey);
  ...
  <tr>
    <td>&nbsp;</td>
    <td><input type="submit" name="Submit" value="Crea mi direccion!!!" class="botonenviarhome" />  
  </table>
...
<p><br />
  <strong>Algunas direcciones ya creadas:</strong><br /></p>
<?
