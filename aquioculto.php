...
<!-- Añade esta etiqueta donde quieras colocar el botón +1 -->
 ...
 &nbsp;<div class="fb-like" data-href="http://www.comoseva.com/<? echo utf8_encode($texto); ?>" data-layout="button_count" data-send="false" data-width="150" data-show-faces="true"></div><br>
	<img src="/images/1pix.gif" height="20"><br>
	<?
		//if ($row[20] <> "no") //descomentar para habilitar adwords
		if ($row[20] == "mecasoensoria") //como el resultado es imposible, lo uso para deshabilitar adwords
		{
		?>
		
		<!-- EMPIEZA ADWORDS : lo quito temporalmente el 7 de diciembre -->
<script type="text/javascript"><!--
...
?>
 ...
 <tr>
   <td align="center"><h1>C&oacute;mo se va   a... <? 
		...
		?> <? if($row[22]) { ?> (<? echo $row[22]; ?>) <? } ?></h1><?  if ($row[7]){ ?><br /> <span class="comentarios"><b><font size=3><?  echo nl2br($row[7]); ?></font></b></span><? }
...
{ 
?>
<br><span class="comentarios"><font size="3"><b><? echo $rowco[1]; ?></b> (Por <? echo $rowco[6]; ?>, <?  echo date("d-m-Y",strtotime($rowco[3]));    ?>)</font></span>
<?
}
?>
<br><span class="comentarios"><a href="#comments" onClick="javascript:showlayer('mas2')">(+) Publica tu comentario</a></span>
<?
}
else
{
?>
<br><span class="comentarios">(Todavía no hay comentarios. <a href="#comments" onClick="javascript:showlayer('mas2')">(+) Publica tú el primero</a>)</span>
<?	
...
<!-- TERMINA COMENTARIOS -->
<?
if ($row[4]){ ?><br /><span class="comentarios">Punto creado el: <?  echo date("d-m-Y",strtotime($row[4])); ?></span><? } ?>
...
<li><a href="http://maps.yahoo.com/#mvt=m&amp;lat=<? echo $row[2]; ?>&amp;lon=<? echo $row[3]; ?>&amp;zoom=17&amp;q1=<? echo $texto; ?>" target="_blank">Abrir en Yahoo Maps</a></li>
 ...
 <a href="http://chart.apis.google.com/chart?cht=qr&chs=400x400&chl=http%3A//www.comoseva.com/<? echo $texto; ?>&chld=L|0" target="_blank"><img src="http://chart.apis.google.com/chart?cht=qr&chs=200x200&chl=http%3A//www.comoseva.com/<? echo $texto; ?>&chld=L|0" height="200" width="200" border="0"></a></li>
 <?
		if($row[14]){
		?>
...
<!-- USERVOICE -->
<!-- Begin: www.iperceptions.com --><script src="http://ips-invite.iperceptions.com/webValidator.aspx?sdfc=1f5a03f7-110607-cb73aae8-316b-46d8-b50b-2f8bb00aa6ed&lID=3&loc=STUDY&cD=90&rF=False&iType=1&domainname=0" type="text/javascript" defer="defer" ></script><!-- End: www.iperceptions.com -->
</body> 
</html> 