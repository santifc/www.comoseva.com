...
<html>
	...
	<meta http-equiv="description" content="Comparte fácilmente la ruta hacia el destino que tú elijas" />
        <title>Puertos de monta&ntilde;a - <?php include($_SERVER['DOCUMENT_ROOT'].'/includes/title.php'); ?></title>
...
$consultan="select * from coordenadas where usar = 'si' and en_lista = 'si' and tipo = 1 order by texto";
...
<table width="950" border="0" cellpadding="2" cellspacing="2">
  <tr>
    <td><strong><a href="../ya-creadas.php">Directorio</a> : Puertos de monta&ntilde;a (<? echo "$num_rows"; ?>):</strong></td>
  </tr>
