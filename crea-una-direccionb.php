...
<form action="#" onSubmit="showAddress(this.address.value); return false" > 
      ...
      <input type="submit" value="Buscar" /> o <strong>arrastra</strong> el icono hasta el punto exacto:
    </form> 
 ...
 <tr>
  ...
  <font color="#999999" size="1">(no saldr&aacute; en la p&aacute;gina) </font></td>
    ...
    <tr>
      <td align="right">&nbsp;</td>
      <td align="right" valign="top"><strong><font color="#FF0000" size="3">NUEVO!</font></strong> URL privada </td>
