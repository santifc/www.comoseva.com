...
<html>
	...
	<meta http-equiv="description" content="Comparte fácilmente la ruta hacia el destino que tú elijas" />
        <title>Puntos ya creados - <?php include($_SERVER['DOCUMENT_ROOT'].'/includes/title.php'); ?></title>
...
<table width="950" border="0" cellpadding="2" cellspacing="2">
  ...
  <tr>
    <td><strong>Algunos puntos ya creados:</strong></td>
  </tr>
  <tr>
    <td><strong><a href="/direcciones/puertos-montana.php"><font size="3">Puertos de monta&ntilde;a (<? echo "$num_rows"; ?>) </font></a><br>
	<a href="/direcciones/talleres.php?orden=a"><font size="3">Talleres (<? echo "$num_rowst"; ?>) </font></a><br> <a href="/direcciones/hostales.php"><font size="3">Hostales (<? echo "$num_rowsp"; ?>) </font></a>
	</strong></td>
  </tr>
   <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td><strong>Ultimos puntos creados (<a href="mapa-dinamico.php">Ver en modo mapa</a>): </strong></td>
  </tr>
  <tr><td>
  <ul>
<?
