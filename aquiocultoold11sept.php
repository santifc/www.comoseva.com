...
?>. Como llegar en coche desde un punto inicial elegido. Con info GPS" />
    ...
    <script type="text/javascript">
		...
		function formCompletado(form)
		{
			...
			{
				alerta(form.email, "Escribe tu email, no aparecerá en el deseo");
			}
...
<div class="addthis_toolbox" id="adthis">
    <div class="vertical">
        ...
        <div class="more">
            <a href="#comments" onclick="javascript:showlayer('mas')">Comentar (+)</a>
	    <div id="mas" style="display:none;">
<form id="form" name="form" method="post" action="enviacomentario.php" onSubmit="return formCompletado(this)">
...
<!-- COMENTARIOS -->
<br />
<span class="comentariostitle"><a name="comments">Comentarios:</a></span>
...
?><br><img src="/images/1pix.gif" height=4><br>
<a href="javascript:void(0);" onclick="javascript:showlayer('mas')" style="text-decoration:none; color:#999999; font-weight:bold">[añade comentario]</a></b>
<!-- TERMINA COMENTARIOS -->
