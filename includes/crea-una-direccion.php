...
<form action="#" onSubmit="showAddress(this.address.value); return false" > 
      ...
      o <strong>haz zoom </strong> a la localizaci&oacute;n en este mapa:
    </form> 
  ...
  <table width="980">
    ...
    <td valign="middle">
  <input name="textoprincipal" type="text" id="textoprincipal" size="50" onBlur="this.value=removeSpacesb(this.value);" <? if($txt) { ?> value="<? echo $txt; ?>" <? }  ?> />
